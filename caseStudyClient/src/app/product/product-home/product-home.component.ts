...
// Observables
vendors$?: Observable<Vendor[]>; // for employee drop down
...
products.map((prod) => {this.products.push(prod.id)});
...
save(product: Product): void {
 ...
 this.products.indexOf(product.id) === -1 ? this.add(product) :this.update(product) ;
} // save
/**
